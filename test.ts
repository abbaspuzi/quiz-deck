...
const visualTellQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    answer: "Laycie",
    explain: "The 3-ribbon count on the cream wrap is a unique technical identifier for Laycie.",
  },
  {
...
const sizeScaleQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    category: "size-scale",
    type: "counting",
    prompt: "For a Beatrice LUXE order, what is the required hardware and hero lily count?",
    options: [
    ...
    explain: "Standard = 3 Lilies in a Standard box; Luxe = 5 Lilies in an XL box.",
  },
  {
    id: "q17-marilyn-size",
    cluster: "russian-wraps",
    category: "size-scale",
    type: "counting",
    prompt: "What size is this Marilyn Pink Carnation Bouquet?",
...
const scenarioQuestions: QuizQuestion[] = [
  {
    ...
    answer: "Zendaya Box",
    explain: "While both can use Greenheart centers, only Zendaya includes the Red Rose Spray.",
  },
  {
  ...
  },
  {
    ...
    category: "scenario",
    type: "scenario",
    prompt: "Look at the photo. Is this an Ayame or a Zaylee?",
  ...
  },
  {
    ...
    explain: "The Zooey Bouquet uses Greenheart sunflowers, whereas the Zooey Box uses Blackheart.",
  ...
  },
  {
    ...
    category: "scenario",
    type: "single_choice",
    prompt: "Look at this Laycie. Something is missing. What is it?",
    options: [
...
const ingredientAuditQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    category: "ingredient-audit",
    type: "single_choice",
    prompt: "To correctly identify the Zaylee Flower Box, which ingredients must be present?",
    options: [
  ...
  },
  {
    ...
    category: "ingredient-audit",
    type: "single_choice",
    prompt: "What specific mix defines the Zooey Sunflower Mother's Day Bouquet?",
    options: [
...
const orchidQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    category: "orchid-id",
    type: "single_choice",
    prompt: "What is the product name of this orchid?",
    options: [
      "Indira Pink & White Phalaenopsis Orchid",
      "Mother's Day Pink Phalaenopsis Orchid (2 stalks)",
  ...
  },
  {
    ...
    category: "orchid-id",
    type: "single_choice",
    prompt: "What specific ingredients make up the Indira Pink & White Orchid arrangement?",
    options: [
...
const visualIdQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    explain:
      "Izzy features Pink Gerbera, Red Carnations, Yellow Rose Spray, Mini Fruit Leaf, and Scabiosa Pod.",
  ...
  },
  {
    ...
    explain:
      "Phoebe features Hot Cherry Pink Carnations, Pink Carnations, White Dendrobium Orchid, and Purple Capsia.",
...
const thisOrThatQuestions: QuizQuestion[] = [
  {
    ...
    answer: "Left",
    explain:
      "Left is Miriam (yellow wrapper, white ribbon). Right is Marilyn (pink wrapper, black ribbon).",
    images: [
      "/quiz-images/miriam-pink-carnation-mothers-day-russian-bouquet-standard.png",
      "/quiz-images/marilyn-carnation-mothers-day-russian-bouquet-standard.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Zendaya (Greenheart Sunflowers with Red Rose Spray). Right is Zooey Box (Blackheart Sunflowers, no Red Rose Spray).",
    images: [
      "/quiz-images/zendaya-yellow-sunflower-mothers-day-flower-box.png",
      "/quiz-images/zooey-yellow-sunflower-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    images: [
      "/quiz-images/beatrice-rose-lily-mothers-day-flower-box.png",
      "/quiz-images/tessa-pink-lily-mothers-day-flower-box-large.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Ayame (1 Anthurium, Pink Gerberas). Right is Zaylee (2–3 Anthuriums, Lilac Spidermums, no Gerberas).",
    images: [
      "/quiz-images/ayame-pink-gerbera-mothers-day-flower-box-large.png",
      "/quiz-images/zaylee-pink-mum-mothers-day-flower-box-large.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Indira (mixed pink & white stalks, pink decorative base wrap). Left is the standard Pink Phalaenopsis Orchid (2 stalks, plain pot).",
    images: [
      "/quiz-images/image10.png",
      "/quiz-images/indira-pink-white-mothers-day-phalaenopsis-orchid.png",
    ],
  },
  {
    ...
    images: [
      "/quiz-images/tessa-pink-lily-mothers-day-bouquet-standard.png",
      "/quiz-images/trixie-pink-lily-mothers-day-bouquet.png",
    ],
  },
];
...
const flowerRecogniseQuestions: QuizQuestion[] = [
  {
    ...
    answer: "Left",
    explain:
      "Left is Mischa (pink wrapper, Pink Carnation + White Eustoma + Matthiola). Right is Laycie (cream wrapper, 3 pink rubber ribbons, Ocean Song Rose).",
    images: [
      "/quiz-images/mischa-pink-carnation-mothers-day-bouquet-large.png",
      "/quiz-images/laycie-lilac-rose-mothers-day-bouquet-standard.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Laycie (cream wrapper with pink rubber ribbons, Ocean Song Rose + Phalaenopsis Orchid). Left is Mischa (pink wrapper, Pink Carnation + White Eustoma).",
    images: [
      "/quiz-images/mischa-pink-carnation-mothers-day-bouquet-large.png",
      "/quiz-images/laycie-lilac-rose-mothers-day-bouquet-standard.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Phoebe (Hot Cherry Pink Carnation, White Dendrobium Orchid, Purple Capsia). Right is Zandra (Pink Gerbera, Hot Cherry Pink Rose, Rose Spray).",
    images: [
      "/quiz-images/phoebe-pink-carnation-mothers-day-flower-box-large.png",
      "/quiz-images/zandra-pink-gerbera-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Izzy (Pink Gerbera, Peach Gerbera, Red Carnations, Yellow Rose Spray). Right is Zandra (Pink Gerbera, Hot Cherry Pink Rose, no yellow flowers).",
    images: [
      "/quiz-images/izzy-pink-daisy-mothers-day-flower-box-medium.png",
      "/quiz-images/zandra-pink-gerbera-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Lyndi (heart-shaped Red Roses in white wrapper with pink ribbons). Right is Luxe Kate (XL Hatbox with Red Roses in mushroom shape).",
    images: [
      "/quiz-images/lyndi-red-rose-mothers-day-heart-bouquet-large.png",
      "/quiz-images/luxe-kate-red-rose-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Zooey Bouquet (Greenheart Sunflowers in pink wrapper with Alstroemeria). Right is Zooey Box (Blackheart Sunflowers in peach hatbox).",
    images: [
      "/quiz-images/zooey-yellow-sunflower-mothers-day-bouquet.png",
      "/quiz-images/zooey-yellow-sunflower-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Beatrice (Red Roses + White/Pink Roses + Lilies in peach hatbox). Right is Luxe Kate (XL Hatbox with ONLY Red Roses in mushroom dome shape).",
    images: [
      "/quiz-images/beatrice-rose-lily-mothers-day-flower-box.png",
      "/quiz-images/luxe-kate-red-rose-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Zaylee (2-3 Anthuriums, Lilac Spidermums, NO Gerberas). Right is Zandra (Pink Gerbera, Hot Cherry Pink Rose, Rose Spray).",
    images: [
      "/quiz-images/zaylee-pink-mum-mothers-day-flower-box-medium.png",
      "/quiz-images/zandra-pink-gerbera-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Marilyn (pink/black Russian wrapper, Pink Gerbera, no Matthiola). Right is Mischa (pink wrapper, White Eustoma + Matthiola, not Russian-style).",
    images: [
      "/quiz-images/marilyn-carnation-mothers-day-russian-bouquet-standard.png",
      "/quiz-images/mischa-pink-carnation-mothers-day-bouquet-large.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Tessa (Pink Lilies + Avalanche/White Roses in peach hatbox). Left is Phoebe (Hot Cherry Pink Carnations + White Dendrobium Orchid).",
    images: [
      "/quiz-images/phoebe-pink-carnation-mothers-day-flower-box-large.png",
      "/quiz-images/tessa-pink-lily-mothers-day-flower-box-large.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Izzy (colourful mix: Pink Gerbera, Red Carnation, Yellow Rose Spray, Scabiosa Pod). Left is Phoebe (pink-red tones: Hot Cherry Pink Carnation, White Dendrobium Orchid).",
    images: [
      "/quiz-images/phoebe-pink-carnation-mothers-day-flower-box-large.png",
      "/quiz-images/izzy-pink-daisy-mothers-day-flower-box-large.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Luxe Kate (XL Hatbox, ONLY Red Roses in a mushroom dome). Right is Beatrice (mixed Red Roses + White/Pink Roses + Lilies).",
    images: [
      "/quiz-images/luxe-kate-red-rose-mothers-day-flower-box.png",
      "/quiz-images/beatrice-rose-lily-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Zendaya (Greenheart Sunflowers WITH Red Rose Spray in peach box). Left is Zooey Box (Blackheart Sunflowers, NO Red Rose Spray).",
    images: [
      "/quiz-images/zooey-yellow-sunflower-mothers-day-flower-box.png",
      "/quiz-images/zendaya-yellow-sunflower-mothers-day-flower-box.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Trixie (purple wrapper — the only MDAY product with purple). Left is Mischa (pink wrapper, Pink Carnation + White Eustoma).",
    images: [
      "/quiz-images/mischa-pink-carnation-mothers-day-bouquet-large.png",
      "/quiz-images/trixie-pink-lily-mothers-day-bouquet.png",
    ],
  ...
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Indira (mixed pink + white stalks, pink decorative fabric wrap). Right is the standard Pink Phalaenopsis Orchid (all-pink stalks, plain white pot).",
    images: [
      "/quiz-images/indira-pink-white-mothers-day-phalaenopsis-orchid.png",
      "/quiz-images/image10.png",
    ],
  },
  {
    ...
    answer: "Right",
    explain:
      "Right is Miriam (yellow wrapper, white ribbon, includes White Matthiola). Left is Marilyn (pink wrapper, black ribbon, NO Matthiola).",
    images: [
      "/quiz-images/marilyn-carnation-mothers-day-russian-bouquet-standard.png",
      "/quiz-images/miriam-pink-carnation-mothers-day-russian-bouquet-standard.png",
    ],
  },
  {
    ...
    answer: "Left",
    explain:
      "Left is Zandra (Pink Gerbera + Hot Cherry Pink Rose + Rose Spray). Right is Ayame (1 Anthurium + Pink Gerberas, no Hot Cherry Pink Rose).",
    images: [
      "/quiz-images/zandra-pink-gerbera-mothers-day-flower-box.png",
      "/quiz-images/ayame-pink-gerbera-mothers-day-flower-box-large.png",
    ],
